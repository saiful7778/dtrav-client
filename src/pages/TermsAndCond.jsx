const TermsAndCond = () => {
  return (
    <div>
      ...
      <p>Welcome to dtrav!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of dtrav travel company's Website, located at
        https://dtrav-travle.web.app/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use dtrav if you do not agree to take all
      ...
      <p>
        We employ the use of cookies. By accessing dtrav, you agreed to use
        cookies in agreement with the dtrav travel company's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, dtrav travel company and/or its licensors own
        the intellectual property rights for all material on dtrav. All
        intellectual property rights are reserved. You may access this from
        dtrav for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from dtrav</li>
        <li>Sell, rent or sub-license material from dtrav</li>
        <li>Reproduce, duplicate or copy material from dtrav</li>
        <li>Redistribute content from dtrav</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. dtrav
        travel company does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of dtrav travel company,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, dtrav travel
        company shall not be liable for the Comments or for any liability,
      ...
      <p>
        dtrav travel company reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant dtrav travel company a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of dtrav travel company; and (d)
      ...
      <p>
        ...
        e-mail to dtrav travel company. Please include your name, your
      ...
      <p>
        No use of dtrav travel company's logo or other artwork will be allowed
