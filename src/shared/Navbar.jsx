  ...
  return (
    <>
      <motion.nav
        ...
        className="fixed left-0 top-0 z-[100] w-full border-b border-gray-300 bg-gray-100"
      >
        <div className="container flex h-fit w-full items-center justify-between p-2">
          <SiteLogo />
